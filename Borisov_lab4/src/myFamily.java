...
public class myFamily {
        ...
        while(true){
            ...
            switch(command)
            {
                ...
                case "3":
                    ...
                    break;
                case "4":
                    System.out.println("4.Запись списка в файл out.txt");
                    ...
                    break;
                case "5":
                    System.out.println("5.Чтение списка из файла out.txt");
                    FileInputStream fis = new FileInputStream ("out.txt");
                    ObjectInputStream ois = new ObjectInputStream (fis);
                    member = (ArrayList) ois.readObject();
                    ois.close();
                    fis.close();
                    break;
                case "help":
    ...
    static void help()
    {
        ...
        System.out.println("4. Записать список в файл out.txt");
        System.out.println("5. Прочитать список из файла out.txt");
